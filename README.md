...
[<img src="http://maxcdn.liewcf.com/blog/wp-content/uploads/twitter-tweet-button.jpg" height="26" width="70">](https://twitter.com/share?text=Checkout+simple_ruby_DSL+based+data+anonymization+tool+for+getting+production+data+dump&url=http:%2F%2Fsunitparekh.github.com%2Fdata-anonymization&via=dataanon&hashtags=dataanon)
